# This script generates background sequences, makes predictions using a trained model, and saves statistical metrics.
# It reads model parameters, a model file, and a TSV file with shuffled sequences, then processes these sequences
# to generate predictions and compute specified statistical metrics. The script also supports multi-GPU execution
# using SLURM and can save prediction maps if requested.

# Inputs:
# - params_file: JSON file containing model parameters.
# - model_file: Model file to be used for predictions.
# - shuffled_seqs_tsv: TSV file with shuffled sequences.
...
# - Statistical metrics saved in an HDF5 file.

# Example command-line usage:
# python generate_scores_for_shuffled_insertions.py params.json model_file.h5 shuffled_seqs.tsv
