# This script generates predictions using a trained model and saves statistical metrics.
...
# python generate_scores_for_shuffled_seqs.py params.json model_file.h5 shuffled_seqs.tsv
...
def main():
    ...
    preds_stream = stream.PredStreamGen(
        seqnn_model,
        shuffled_sequences_gen(seq_coords_df, genome_open),
        batch_size,
    )
