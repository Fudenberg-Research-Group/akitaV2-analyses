...
tsv_file="/home1/smaruj/akitaX1-analyses/experiments/background_generation/background_generation/input_data/50seqs_GCuniform_maxSCD35.tsv"
out_dir="/scratch2/smaruj/background_directory/background_sequences" 
models="5 6 7" # this is a string with space seperated model numbers examples "0 1 2" or "4 5 6" 
batch_size=8 
max_iters=20
max_proc=2
processes=2
