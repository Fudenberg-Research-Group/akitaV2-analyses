...
tsv_file="/home1/smaruj/akitaX1-analyses/experiments/virtual_insertion_flanks/input_data/CTCFs_jaspar_filtered_mm10_single_flanks.tsv"
out_dir="/scratch2/smaruj/virtual_insertion/virtual_insertion_single_flanks" 
