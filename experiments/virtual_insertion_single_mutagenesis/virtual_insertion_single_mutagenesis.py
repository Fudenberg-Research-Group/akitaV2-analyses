...
# python virtual_insertion_single_mutagenesis.py params.json model.h5 motifs.tsv -f genome.fa --batch-size 8 --out-dir ./results
...
from akita_utils.seq_gens import single_mutagenesis_seqs_gen
