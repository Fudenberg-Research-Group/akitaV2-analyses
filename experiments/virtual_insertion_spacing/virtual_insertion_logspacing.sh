...
tsv_file="/home1/smaruj/akitaX1-analyses/experiments/virtual_insertion_spacing/input_data/CTCFs_jaspar_filtered_mm10_subsampled_logspacing_bg0_P3_D.tsv"
out_dir="/scratch2/smaruj/spacing/all_sites_D_P3" 
