...
# tsv_file="/home1/smaruj/akitaX1-analyses/experiments/virtual_insertion_dots_vs_boundaries/input_data/boundary_windows/boundary_CTCFs_jaspar_filtered_mm10_strong.tsv" # for boundary windows
tsv_file="/home1/smaruj/akitaX1-analyses/experiments/virtual_insertion_dots_vs_boundaries/input_data/dot_windows/boundary_CTCFs_jaspar_filtered_mm10_strong_dots.tsv" #for dot windows
out_dir="/scratch2/smaruj/virtual_insertion_boundaries_DW" 
